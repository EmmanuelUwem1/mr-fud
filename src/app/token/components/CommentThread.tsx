    ...
    <div className="w-full">
      ...
      <div className="">
        ...
        <div className="lg:hidden flex justify-start items-center border-b border-[#2A2A2A] sm:px-4 py-3 text-xs font-semibold w-full">
          ...
          <span
            className={`relative flex items-center justify-center h-5 w-5 justify-self-end cursor-pointer ml-auto transition-class ${isCollapsed ? "-rotate-180" : "rotate-180"}`}
