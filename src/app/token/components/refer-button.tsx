    ...
    return (
      <div className="flex items-center justify-start gap-3">
        <button
          ...
          className="text-xs font-medium flex items-center justify-center gap-2 w-fit lg:w-40 bg-[#00C3FE] lg:rounded-full rounded-md p-3 transition-class hover:opacity-90 cursor-pointer"
        >
