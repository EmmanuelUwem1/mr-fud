        ...
        >
          ...
          <div className="flex flex-col items-center w-full gap-4 z-10">
            <input
              ...
              className="w-full max-w-lg px-4 py-2 rounded-md bg-[#1F1F1F] text-white border border-[#38B9FF] placeholder:text-[#888] focus:outline-none"
            />
            <button className="px-6 py-3 bg-[#00C3FE] hover:bg-[#00c3febc] text-xs font-medium transition-class text-white rounded-full">
              Check Availability
            </button>
          </div>
        </div>
